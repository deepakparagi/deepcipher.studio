...
export default function NeuralBackground({
  className,
  color = "#B8956A", // Default Deepcipher Gold
  trailOpacity = 0.15,
  particleCount = 600,
  speed = 1,
  ...
  return (
    <div ref={containerRef} className={cn("absolute inset-0 w-full h-full bg-[#0A0A0A] overflow-hidden pointer-events-none z-0", className)}>
